...
Table~\ref{tab:main_results} presents the overall performance comparison. MemSt's Hierarchical Summary strategy achieves \textbf{41.7\% F1}, representing an \textbf{84\% improvement} over the RAG baseline (22.6\%) and competitive performance with the full-context approach (80.7\%) at only 7\% of the token cost.
