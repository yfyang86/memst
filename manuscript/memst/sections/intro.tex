...
\begin{itemize}
    ...
    \item \textbf{Hierarchical Retrieval Strategies}: Multi-level memory organization (session summaries $\rightarrow$ key turns $\rightarrow$ full context) with dynamic token budget allocation, achieving best overall performance (41.7\% F1) with 85ms latency.
