...
\begin{enumerate}
    \item \textbf{Question-Adaptive Routing}: Dynamic strategy selection based on question classification, achieving \textbf{49.2\% F1} on LOCOMO---a \textbf{118\% improvement} over RAG baselines and outperforming all specialized strategies.
